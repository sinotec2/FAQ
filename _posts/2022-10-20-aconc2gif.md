...
sidebar:
  nav: layouts
date:  2022-10-20
modify_date: 2022-10-21 11:02:54
---
...
- NCO程式：其中的ncks及ncrcat，進行模擬結果檔案的切割與連接。參考[使用手冊](https://nco.sourceforge.net/nco.pdf)、或[教學範例](http://research.jisao.washington.edu/data_sets/nco/)
