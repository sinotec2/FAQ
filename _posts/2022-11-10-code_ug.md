...
|:--:|:--:|
| <b>圖8 [VS Code][vsc_wiki]界面右上角功能</b>| <b>圖9 右下角功能</b>|
...
- 文件版本比較之顏色表示(行號右側、縮圖左側、拉桿左側，如圖10)
  - 相對於GitHub上的版本
  - 綠色：此次新增 
  - 藍色：修改
  - Push更新GitHub之後，這些顏色就會消失

| ![find_snip.PNG](https://github.com/sinotec2/Focus-on-Air-Quality/raw/main/assets/images/find_snip.png)|
|:--:|
| <b>圖10 右側文件縮圖與拉桿上顏色的分布</b>| 
