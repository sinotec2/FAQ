...
- 什麼樣的人會需要使用[VS Code][vsc_wiki]
  - 程式發展者
  - md檔案及部落客
  - 厭倦word或其他軟體，尋找更好的數位化筆記系統的人

### 推介
- 台大資訊系計算機程式設計課程指定使用、([鄭士康 2018](https://nol.ntu.edu.tw/nol/coursesearch/print_table.php?course_id=901%2033900&class=&dpt_code=0000&ser_no=21041&semester=107-2))
...
## [VS Code][vsc_wiki]安裝
- Code也可以直接在browser上執行。功能完全與安裝版一樣。詳見[https://vscode.dev/](https://vscode.dev/)
...
- 沒有「最近編輯的檔案」功能。
  ...
  - 所以如果去檔案(F)下拉選單找到的「開啟最近檔案」會是其他專案(檔案)，而不是正編輯[Repo][repo]最近的編輯檔案。
  - 因應這項缺點，
