...
- 在github中抄一份foam模板
  ...
  6. 進入VSCode時系統會提示安裝Foam及其他插件(第一次)，一一安裝即可。（插件包括：Markdown All in One、Markdown Emoji、[Paste Image][PI]、Todo Tree 和 Spell Right 等）
...
[MP]: https://marketplace.visualstudio.com/items?itemName=foam.foam-vscode "Foam |  85,739 installs
|(25) | Free, VS Code + Markdown + Wikilinks for your note taking and knowledge base"
