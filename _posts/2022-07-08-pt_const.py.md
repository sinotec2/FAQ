...
## 說明
- 整體工作流程詳見[CMAQ點源常數檔案之準備](https://sinotec2.github.io/Focus-on-Air-Quality/GridModels/PTSE/1.pt_constWork/)
...
```
- 輸入檔(ptse檔案)：[ptsEnHRBE.py](https://sinotec2.github.io/FAQ/2022/07/15/ptsEnHRBE.py程式說明.html)結果
