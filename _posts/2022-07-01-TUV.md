...
## 背景
- CAMx的光解係數是一個很大的對照表，由網格所在位置的臭氧垂直濃度(參見[[2022-07-01-TOMS]])、返照率、也考慮到地形及離地高度，範例如下所示。
...
[2022-07-01-TOMS]: https://sinotec2.github.io/FAQ/2022/07/01/TOMS.html "臭氧垂直濃度之處理"
