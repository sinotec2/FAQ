...
- timvar模版特色
  ...
  - 污染物名稱與反應機制的選擇有關。如有別的名稱，可以在CMAQ執行的時候，在[$EMISSCTRL_NML][emsctr]檔案中添加對照關係(參[[2022-07-07-EMISSCTRL_NML]][^1])
  - 可以參考CMAQ公開包裏的檔案。
...
[^1]: https://sinotec2.github.io/FAQ/2022/07/07/EMISSCTRL_NML.html " EMISSCTRL_NML之設定"
