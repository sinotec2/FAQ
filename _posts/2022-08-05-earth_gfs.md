...
- 因為[GFS][GFS]檔案時間皆為UTC，需先取得當下UTC的年月日時。小時數需round到每隔3的間距，並取2碼文字。
- 先執行地面項目的連結
  - 地面臭氧為[CAMS][CAMS]數據，[另行下載計算](https://sinotec2.github.io/FAQ/2022/08/03/wind_ozone.html#數據下載與轉換)。
- 再執行1000mb項目的連結
