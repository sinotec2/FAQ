...
- 中國東吳大學團隊[Khan et al., 2022][doi2][^2]
...
[^2]: Khan, S., Muhammad, K., Hussain, T., Del Ser, J., Cuzzolin, F., Bhattacharyya, S., Akhtar, Z., Albuquerque, V.H.C. (2021). **DeepSmoke: Deep Learning Model for Smoke Detection and Segmentation in Outdoor Environments.** Expert Systems with Applications 182, 115125. [doi][doi2]
...
[^8]: Koushafar, M., Sohn, G., Gordon, M. (2023). **Deep Convolutional Neural Network for Plume Rise Measurements in Industrial Environments.** Remote Sensing 15, 3083. [doi](https://doi.org/10.3390/rs15123083)
[^9]: Li, D., Yang, R., Su, C. (2023). **Generative adversarial network based on LSTM and convolutional block attention module for industrial smoke image recognition.** Computer Science and Information Systems 27–27. [doi](https://doi.org/10.2298/CSIS221125027L)
...
[doi2]: https://doi.org/10.1016/j.eswa.2021.115125 "(Khan et al., 2022)"
