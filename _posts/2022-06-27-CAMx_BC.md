...
- 因Fortran程式為循序存取，python則為直接存取，對於存取順序有不同的要求，程式設計上有很大的差異。
...
- 此處提供2個模式邊界濃度檔案格式的差異(Python平台)，以提供未來進一步撰寫轉換程式之需求。
...
|CPROJ|2|-||
|ISTAG|0|-||
|PLON, PLAT, TLAT1, TLAT2|120.99, 23.61, 10.0, 40.0|-||
...
## 自空品濃度檔案截取邊界濃度
- CAMx官網提供了截取fortran程式BNDEXTR，其使用方法詳見[從空品檔案切割邊界濃度 BNDEXTR](https://sinotec2.github.io/FAQ/2022/06/25/bndex.job.html)
