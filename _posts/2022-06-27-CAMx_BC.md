---
title: CAMx 模式的BC
tags: CAMx fortran bash ncks ncatted sed date uamiv
layout: article
aside:
  toc: true
sidebar:
...
|[CAM-chem][ccm](see [[2022-06-24-CAMx_ICBC]])|1.25 &times; 0.94度、6小時|高解析度|低準確度|
...
### 截取程式
- CAMx官網提供了截取程式bndextr.f，其使用方法詳見[從空品檔案切割邊界濃度 BNDEXTR](https://sinotec2.github.io/FAQ/2022/06/25/bndex.job.html), [[2022-06-25-bndex.job]]
...
[2022-06-24-CAMx_ICBC]: https://sinotec2.github.io/FAQ/2022/06/24/CAMx_ICBC.html "CAMx
[2022-06-26-pncgen]: https://sinotec2.github.io/FAQ/2022/06/26/pncgen.html "ncgen
[2022-06-24-CAMx_ICBC]: https://sinotec2.github.io/FAQ/2022/06/24/CAMx_ICBC.html "CAMx
