...
- [earth][eth]內設是等間距經緯度系統，(但該等json檔案似乎也可以接受直角座標系統)，此處需將WRF及CMAQ的直角座標系統進行轉換。
  ...
  3. 內插方式還可精進(詳下：[[#搜尋半徑版本cmaq_json2.py]])。
- 時間迴圈之外座標轉換相關的設定
...
[2022-07-27-uv10_json]: https://sinotec2.github.io/FAQ/2022/07/27/uv10_json.html "地面風wrfout檔轉json"
[#搜尋半徑版本cmaq_json2.py]: https://sinotec2.github.io/FAQ/2022/08/31/cmaq_json.html "earth套件展示wrfout與CCTM_ACONC結果"
